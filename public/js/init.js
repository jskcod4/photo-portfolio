  ...
  btn.each(function () {
    ...
    element
      .on("mouseenter", function () {
        element.css({ backgroundColor: "beige" });
...
function photolane_fn_halfslide_h() {
  ...
  jQuery(".photolane_fn_halfslide .flexslider ul.slides > li").css({
    height: H - submenuH,
  });
}
// -----------------------------------------------------
    ...
    if (subMenu.length) {
      ...
      if (!subMenu.parent("li").hasClass("active")) {
        ...
        setTimeout(function () {
          ...
          jQuery(".photolane_fn_leftbar_nav_in.scrollable").css({
            height: jQuery(window).height() + 1,
          });
          photolane_fn_vertical_menu_scroll();
        }, 500);
      } else {
...
function photolane_fn_volume() {
  ...
  jQuery(".photolane_fn_leftbar a.volume").on("click", function () {
    if (!jQuery(this).hasClass("opened")) {
      ...
      jQuery(".photolane_fn_leftbar a.volume svg.volumeoff").removeClass(
        "hidden"
      );
      ...
      jQuery(".photolane_fn_leftbar a.volume svg.volumeon").removeClass(
        "hidden"
      );
    }
    return false;
  ...
  jQuery(".photolane_fn_horizontal_menu a.volume").on("click", function () {
    if (!jQuery(this).hasClass("opened")) {
      jQuery(this).addClass("opened");
      jQuery(
        ".photolane_fn_horizontal_menu a.volume svg.volumeoff"
      ).removeClass("hidden");
      jQuery(".photolane_fn_horizontal_menu a.volume svg.volumeon").addClass(
        "hidden"
      );
    } else {
      jQuery(this).removeClass("opened");
      jQuery(".photolane_fn_horizontal_menu a.volume svg.volumeoff").addClass(
        "hidden"
      );
      jQuery(".photolane_fn_horizontal_menu a.volume svg.volumeon").removeClass(
        "hidden"
      );
    }
    return false;
...
function photolane_fn_next_slide_button() {
  ...
  jQuery(".photolane_fn_main_slider .photolane_fn_overlay").on(
    "click",
    function () {
      setTimeout(function () {
